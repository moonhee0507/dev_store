...
import ProductCard from "../common/productCard/productCard.js";
import { SearchListItem, NotInSearch } from "./index.js";
...
class SearchList {
    ...
    async setProductList() {
        ...
        if (this.productsOnAllPages.length === 0) {
            const notInSearch = new NotInSearch();
            this.wrapper.appendChild(notInSearch.render());
        }
