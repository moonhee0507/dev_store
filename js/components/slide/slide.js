class Slide {
    ...
    render() {
        ...
        slide1.style.background = "url('/assets/images/slide_1.png')";
        slide1.innerHTML = `
        ...
        slide2.style.background = "url('/assets/images/slide_2.png')";
        slide2.innerHTML = `
            <a href="" target="_blank" class="link-slide"></a>
        `;
        ...
        slide3.style.background = "url('/assets/images/slide_3.png')";
        slide3.innerHTML = `
            <a href="" target="_blank" class="link-slide"></a>
        `;
